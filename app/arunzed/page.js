...
export default function Home() {
  ...
  return (
<div className='text-stone-700 bg-white //color: rgb(20 184 166); 20,184,166 :  204,251,241'>
...
<div className=''>
{/* <img className='absolute hidden z-[-2] -bottom-4 -right-36 lg:right-44 w-[900px] lg:w-[760px]' src="/arun/aruncrop.svg" alt='arun zed' title='arun zed'></img> */}
...
{/* <div class="absolute top-0 left-10  h-screen w-[1200px]
  ...
  <div className='lg:w-1/2 pt-12 md:pt-20 pl-6 lg:pl-52'>
      ...
      <Image src="/arun/mongodb.svg" width={30} height={32} alt="mongodb"/>
...
{/* Dedicated to <span className='text-teal-500'> turning ideas into creative solutions. </span> */}
  ...
  {/* <div className='flex'>
    ...
    <Image className='rounded-full object-cover' src="/arun/arunsm.svg" width={180} height={180} alt="l"></Image>
