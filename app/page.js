...
<div className='text-stone-700 //color: rgb(20 184 166); 20,184,166 :  204,251,241'>
    ...
    <div className=''>
    <img className='absolute hidden z-[-2] -bottom-4 -right-36 lg:right-44 w-[900px] lg:w-[760px]' src="/aruncrop.svg" alt='arun zed' title='arun zed'></img>
    ...
    {/* <div class="absolute top-0 left-10  h-screen w-[1200px]
      ...
      <div className='lg:w-1/2 pt-12 md:pt-20 pl-6 lg:pl-52'>
          ...
          <div className='flex w-fit border pl-3 pr-2 rounded-md gap-4 mt-8'>

            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="48" viewBox="0 0 48 48">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="34" height="48" viewBox="0 0 48 48">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32" height="48" viewBox="0 0 48 48">
            ...
            <div className='pt-'>
            <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" width="44" height="48">
          ...
          <Image src="/mongodb.svg" width={30} height={32} alt="mongodb"/>
    ...
    <div className="bg-stone-50 pt-12 mx-auto pb-20 lg:px-40">
      ...
      <div className='lg:flex'>
        ...
        <a target="_blank" rel="noopener noreferrer" href='https://mothercabs.com/'>
            <Image className="h-[164px] object-contain shadow-sm" src="/mothercabs.png" width={500} height={500} alt="mothercabs"></Image>
        ...
        <div className="mx-4 lg:mx-auto mt-4 lg:mt-0 p-5 lg:w-[500px] bg-white rounded-2xl shadow-sm">
            <div className=''>
            <Image className="h-[164px] object-contain shadow-sm" src="/l.png" width={500} height={500} alt="l"></Image>
            </div>
            <div className={`tracking-wider pt-4 text-xl text-stone-700 font-medium`}>
    ...
    {/* Dedicated to <span className='text-teal-500'> turning ideas into creative solutions. </span> */}
      ...
      {/* <div className='flex'>
        ...
        <Image className='rounded-full object-cover' src="/arunsm.svg" width={180} height={180} alt="l"></Image>
      ...
      <div className='flex pt-4 justify-center gap-12 text-stone-500'>
        ...
        <a className=' text-white' target="_blank" rel="noopener noreferrer" href='https://arunzeds.com/arunzed'>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="36" height="36" viewBox="0 0 64 64">
          <path fill="#ffffff" d="M 21.580078 7 C 13.541078 7 7 13.544938 7 21.585938 L 7 42.417969 C 7 50.457969 13.544938 57 21.585938 57 L 42.417969 57 C 50.457969 57 57 50.455062 57 42.414062 L 57 21.580078 C 57 13.541078 50.455062 7 42.414062 7 L 21.580078 7 z M 47 15 C 48.104 15 49 15.896 49 17 C 49 18.104 48.104 19 47 19 C 45.896 19 45 18.104 45 17 C 45 15.896 45.896 15 47 15 z M 32 19 C 39.17 19 45 24.83 45 32 C 45 39.17 39.169 45 32 45 C 24.83 45 19 39.169 19 32 C 19 24.831 24.83 19 32 19 z M 32 23 C 27.029 23 23 27.029 23 32 C 23 36.971 27.029 41 32 41 C 36.971 41 41 36.971 41 32 C 41 27.029 36.971 23 32 23 z"></path>
          </svg>
          </a>
      </div>
