...
<div className='tracking-wide text-[17px] pt-6 bg-[#111] text-white font-semibold'>
    ...
    <div className='flex gap-12 pb-4 w-fit mx-auto px-4 lg:px-64'>
          <div className=''>
                <Link aria-label='instagram' alt='instagram' className='text-white' href='https://www.instagram.com/mother_motor'>
          ...
          <div className=''>
                <Link aria-label='pinterest' alt='pinterest' className='text-white' href='https://pin.it/3IFlg6o0T'>
                  <Image className='text-white' src="/more/pinterest.svg" width="24" height="24" alt="Pinterest"/>
                </Link>
          </div>
          <div className=''>
                <Link aria-label='mailid' alt='mailid' className='text-white' target="_blank" rel="noopener noreferrer" href='mailto: azspecification@gmail.com'>
          ...
          <div className=''>
                <Link aria-label='linkedin' alt="linkedin" className='text-white' target="_blank" rel="noopener noreferrer" href='https://linkedin.com/in/arunzeds'>
