...
export default async function ListHero({selectedpost}) {
  
  return ( 
    <div  className='text-black dark:text-white bg-gray-200 dark:bg-gray-800'>
      ...
      <div className='grid gird-cols-1 lg:grid-cols-3 lg:grid-flow-row gap-[26px] mx-auto pt-7 pb-12 w-fit'>
        {selectedpost.map((e)=>{
          return(
