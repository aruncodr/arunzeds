        ...
        <div className='lg:flex mt-15 lg:mt-20'>
            <div className='lg:w-8/12 pt-4 lg:px-4 text-[18px] tracking-wide bg-white'>
              ...
              <ul className='pl-6 pr-3 pt-2'>
                  ...
                  <li className={`flex gap-4 ${z?.evmileage ? "gap-6":null}`}><div className='w-24 text-nowrap'>{z?.evmileage ? "Petrol" :null} Mileage</div><div className='font-semibold'>: &ensp;{z?.mileage}</div></li>
                      {z?.evmileage ? 
                      <li className='flex gap-4'><div className='w-24 text-nowrap'>EV Mileage</div><div className='font-semibold'>: &ensp;{z?.evmileage}</div></li>
                      :null}
